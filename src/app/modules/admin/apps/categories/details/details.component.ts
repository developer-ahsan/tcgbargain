...
export class CategoryDetailsComponents implements OnInit, AfterViewInit, OnDestroy {
    ...
    routesInitialize() {
        this.menuData = [
            {
                id: 'store',
                title: `${this.selectedProduct.name} Details`,
                type: 'group',
                children: [
                    {
                        id: 'store.address',
                        ...
                        type: 'basic',
                        link: `/apps/categories/${this.selectedProduct.id}/information`
                    },
                    {
                        id: 'store.address',
                        ...
                        type: 'basic',
                        link: `/apps/categories/${this.selectedProduct.id}/sub-cats`
                    },
                    {
                        id: 'store.products',
                        title: 'Categories Products',
                        icon: 'mat_outline:collections',
                        type: 'basic',
                        link: `/apps/categories/${this.selectedProduct.id}/cat-products`
                    }
                ]
            }
        ];
